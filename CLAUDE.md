...
| `*-v3.dc.html` (8 root sheets) | **The definitive design references** (owner-approved 2026-08-12): composition and states for the `04` §6.5 registry. Renders and index in `docs/proofs/design-references/`. Full-screen compositions of the 62 `04` §8 families: `docs/proofs/screen-mockups/` (not canon, not a ninth sheet). A rendering — `04` still owns every value |
...
This project is indexed by GitNexus as **Pro-Football-Coach** (8460 symbols, 31459 relationships, 270 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
