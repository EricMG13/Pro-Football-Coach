...
1. **A blocking `docs/OPEN-DECISIONS.md` item stands in the phase's way.** As of writing there is
   none — D11 is decided and P0 is unblocked. Do not invent an answer to one that reopens.
